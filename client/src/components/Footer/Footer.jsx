...
/>
          ...
          <p className="text-sm text-gray-300 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">
            © 2023 —
            <a
              href="https://www.facebook.com/WestEndChiropracticRehabilitationCenter/"
              className="text-gray-500 ml-1"
              rel="noopener noreferrer"
              target="_blank"
            >
              @WestEndChiropracticRehabilitationCenter
            </a>
          </p>
          <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
            <a href="https://www.facebook.com/WestEndChiropracticRehabilitationCenter/" className="text-gray-500 cursor-pointer">
            ...
            <a className="ml-3 text-gray-600 cursor-pointer">
              <svg
                fill="currentColor"
                stroke="currentColor"
                className="w-5 h-5"
